...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    case 'blue':
      eyeColor[0].blue.push(starWarsCharacters[i])
      break
    case 'yellow':
      eyeColor[0].yellow.push(starWarsCharacters[i])
      break
    case 'brown':
      eyeColor[0].brown.push(starWarsCharacters[i])
      break
    case 'red':
      eyeColor[0].red.push(starWarsCharacters[i])
      break
    case 'blue-gray':
      eyeColor[0].blueGray.push(starWarsCharacters[i])
      break
    default:
      break
  }
...
let crewMass = 0
while (x < 6) {
  mass.push(starWarsCharacters[x].mass)
  x = x + 1
}
